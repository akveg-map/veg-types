...
# Description: "Prepare slope" ensures that the slope raster lines up with the area raster.
# ---------------------------------------------------------------------------
...
slope_input = os.path.join(topography_folder, 'Slope_10m_3338.tif')

# Define output files
slope_output = os.path.join(ancillary_folder, 'slope_10m_3338.tif')
