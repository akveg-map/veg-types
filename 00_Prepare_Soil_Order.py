...
# Description: "Prepare soil order" ensures that the peatland raster lines up with the area raster.
# ---------------------------------------------------------------------------
...
peat_input = os.path.join(soils_folder, 'Dominant_Soil_Order_Alaska_rf11.tif')

# Define output files
peat_output = os.path.join(ancillary_folder, 'soil_order_10m_3338.tif')
